...
var sub = function sub() {
  return Promise.resolve("subTest").then(function (result) {
    console.log(result);
  });
};
...
/* harmony import */ var _sub__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sub */ "./src/sub.js");
...
var executor = function executor() {
  ...
  var map = new Map();
  map.set("key", "value");
  (0,_sub__WEBPACK_IMPORTED_MODULE_6__.sub)();
};
